...
# plot3d(VX_analytical, VY_analytical, u.(VX_analytical, VY_analytical))
# plot3d!(VX, VY, û)
...
for p in 1:6
    ...
    save(joinpath(pwd(), "plots/2.5_p=$(p).png"), fig)
